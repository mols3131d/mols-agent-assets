...
1. **Plan**: Check [scriptify-plan.md](scriptify/scriptify-plan.md). Outline language, path, and edits. Obtain user approval.
1. **Apply**: Check [scriptify-apply.md](scriptify/scriptify-apply.md). Write script, update markdown, and validate execution.
