...
1. Determine the optimal scripting language based on the context (default to Python unless another language is explicitly better suited).
1. Determine the storage path for the script (e.g., `scripts/` directory if modifying an agent skill).
1. Draft a plan outlining:
