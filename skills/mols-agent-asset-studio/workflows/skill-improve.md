...
2. Follow [backup.md](backup.md).
3. Update frontmatter following [trigger-guide.md](../references/trigger-guide.md).
4. Apply minimal changes resolving the request while preserving unrelated behavior.
5. Run [frontmatter-validate.md](frontmatter-validate.md).
6. If workflows changed, run [router-asset-maintain.md](router-asset-maintain.md).
