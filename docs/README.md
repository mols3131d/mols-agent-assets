---
description: 문서 작업 전에 consumption, agent-assets, development, document, references, asset capsule 중 읽을 docs surface를 선택할 때 사용합니다.
---
...
| [`agent-assets/`](agent-assets/) | Agent Asset 자체를 설계·작성할 때 재사용하는 공통 지식, Skill 관행과 pattern |
