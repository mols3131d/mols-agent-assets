...
관련 pattern이나 외부 authority를 reference할 수 있지만, 그 의존성이 capsule의 핵심 의미를 대신하지는 않습니다.
...
6. Bundle이라면 분할 이유가 있고 entrypoint에서 전체를 탐색할 수 있는가?
