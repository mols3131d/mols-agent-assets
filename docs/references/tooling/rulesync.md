...
Repository-local superset schema나 manual projection semantics는 만들지 않습니다. Vendor-native authored source의 선택과 배치는 [Source Authority](../../development/source-authority.md)를 따릅니다.
...
- authored source placement와 target authority → [Source Authority](../../development/source-authority.md)
