...
- [`scripts/agent_assets/sync_agent_skills.py`](../../../scripts/agent_assets/sync_agent_skills.py)는 lock의 source와 revision을 **읽기만** 합니다. 설치 상태를 맞추는 과정에서 `skills-lock.json`을 다시 쓰지 않습니다.
