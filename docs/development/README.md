---
description: 저장소 개발 작업에서 VCS/Git, GitHub, 작성 원본과 권한, repository layout, validation, testing, evaluation 중 적용할 local policy를 찾을 때 사용합니다.
---
...
- [Validation](validation.md) — 여러 도메인의 validation authority, evidence와 automation boundary
