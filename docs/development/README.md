---
description: 저장소 개발 작업에서 VCS/Git, GitHub, AI agent, 작성 원본과 권한, testing, evaluation 중 적용할 local policy를 찾을 때 사용합니다.
---
...
- [AI Agent](ai-agent/) — `AGENTS.md`, Rule, Skill 중 적절한 instruction surface를 선택하는 entrypoint
