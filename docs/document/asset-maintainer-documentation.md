...
Capsule-specific duplication boundary는 이 문서의 Ownership과 Contract가 소유합니다. Repository-wide 중복 판단 원칙은 [Duplication Boundaries](duplication-boundaries.md)를 따릅니다.
