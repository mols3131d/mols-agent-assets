...
| Working / handoff artifact | `inbox/YYYY-MM-DD/` | 아직 canonical하지 않은 report, review, research, handoff, generated output와 임시 note |
| Retained non-canonical artifact | `inbox/archive/YYYY-MM-DD/` | 현재 정본은 아니지만 artifact 원문 자체를 다시 참고할 가치가 있는 기록 |
...
`inbox/`의 실제 path와 directory usage contract는 [`inbox/README.md`](../../inbox/README.md)가 소유합니다.
