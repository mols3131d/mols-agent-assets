...
- 한국어 표현이 어색하면 자연스러운 영어를 사용합니다.
  ...
  - 한국에서 널리 쓰이는 기술 용어나 고유 명칭은 영어를 그대로 사용할 수 있습니다.
...
| **Agent Assets Used to Manage This Repository** | 이 repository와 관리 대상 Agent Asset을 생성·수정·검증·관리하는 데 사용하는 Agent Asset과 지원 자료 | Default |
...
| **Framework, Tool, and Technology Conventions** | framework, tool, technology에서 언어 또는 표기를 정한 content |
