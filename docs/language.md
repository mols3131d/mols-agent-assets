...
| **Standard and Technical Terms** | standard, specification, product, tool, framework, API, protocol과 같은 명칭 | 통용되는 영어 명칭을 사용함 |
| **Translation-Sensitive Terms** | 한국어로 번역하거나 음역했을 때 매우 어색하거나 의미가 덜 정확해지는 영어 표현과 단어 | 영어를 유지함 |
