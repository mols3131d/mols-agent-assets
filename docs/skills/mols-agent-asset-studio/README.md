...
2. **스크립트 및 명령 우선 수행**:
   - Markdown 검증이나 인덱스 생성 시, LLM이 임의로 추론하기에 앞서 `mols-markdown-scripts`의 공통 Python 스크립트를 먼저 구동합니다.
...
- 하위 스킬 세부 설명: 스킬 생성, 압축, 네이밍 검증 및 라우팅 통합에 관한 내용
