...
| Issue 본문을 작성·재작성·형식 검토 | [`docs/development/github.md`](docs/development/github.md), [`.github/templates/README.md`](.github/templates/README.md), [`.github/templates/issue.md`](.github/templates/issue.md) | Issue authoring 의미와 rendering structure |
| Pull Request description을 작성·재작성·형식 검토 | [`docs/development/github.md`](docs/development/github.md), [`.github/templates/README.md`](.github/templates/README.md), [`.github/templates/pull-request.md`](.github/templates/pull-request.md) | PR description authoring 의미와 rendering structure |
| PR Review를 작성·재작성·형식 검토 | [`docs/development/github.md`](docs/development/github.md), [`.github/templates/README.md`](.github/templates/README.md), [`.github/templates/pull-request-review.md`](.github/templates/pull-request-review.md) | PR Review authoring 의미와 rendering structure |
| PR conversation comment를 작성·재작성·형식 검토 | [`docs/development/github.md`](docs/development/github.md), [`.github/templates/README.md`](.github/templates/README.md), [`.github/templates/pull-request-comment.md`](.github/templates/pull-request-comment.md) | conversation comment authoring 의미와 rendering structure |
| PR inline review comment를 작성·재작성·형식 검토 | [`docs/development/github.md`](docs/development/github.md), [`.github/templates/README.md`](.github/templates/README.md), [`.github/templates/pull-request-inline-comment.md`](.github/templates/pull-request-inline-comment.md) | inline review authoring 의미와 rendering structure |
...
| --- | --- | --- |
| 구체적인 GitHub repository/path/ref/PR/Issue/check/workflow/release를 읽기·검토·변경하거나 GitHub tool action을 수행, 또는 이미 확정된 GitHub target의 follow-up | `github-context` | live repository/ref/object와 적용 context를 확인합니다. Generic Git/GitHub 설명이나 concrete target 이전의 broad discovery에는 선택하지 않습니다. |
