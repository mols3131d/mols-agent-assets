...
- GitHub Issue, Pull Request, PR Review, PR comment와 inline review comment를 작성하거나 실질적으로 다시 쓸 때는 `.github/templates/README.md`와 해당 surface의 템플릿을 따릅니다. 최종 GitHub text에는 미치환 template notation이나 작성 지침을 남기지 않습니다.
