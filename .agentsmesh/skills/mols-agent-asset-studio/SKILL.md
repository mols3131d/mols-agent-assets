...
description: >-
  Design, create, improve, refactor, review, and validate agent assets, and tune
  existing Skills to specific projects, through focused workflows. Use when
  working on Skills, agents, instructions, prompts, hooks, MCP configuration, or
  supporting assets, especially when project-owned structure, authority, and
  validation must be respected.
---
...
`workflows/` contains procedures. `references/` contains supporting rules,
