...
description: Find and select installable Skills from a repository or explicit skill source without installing them. Use to discover available capabilities, match a requested capability, inventory Skills for synchronization, or choose one target-specific sibling before installation. Do not mutate the source or install Skills.
---
