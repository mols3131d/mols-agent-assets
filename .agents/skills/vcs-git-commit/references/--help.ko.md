...
- **컨벤션 수정 방법**:
  ...
  1. 커밋 요청 시 에이전트가 변경된 `.gitmessage` 규칙을 자동으로 감지하여 작성합니다.
  1. 별도 설정이 없는 경우 스킬 내 기본 명세(`references/default-gitmessage.md`)로 동작합니다.
