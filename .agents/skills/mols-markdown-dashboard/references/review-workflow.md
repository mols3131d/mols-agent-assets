...
2. Requirement와 Verification Target의 분모가 근거를 갖는가?
3. status, progress와 gaps가 서로 모순되지 않는가?
4. 오래된 snapshot 또는 stale evidence가 현재 상태로 표현됐는가?
5. 핵심 세 표가 중복 없이 독자의 판단을 돕는가?
