...
Runtime이 읽어야 하는 정보는 `./SKILL.md`, `.agents/skills/mols-skill-creator/references/`, `.agents/skills/mols-skill-creator/scripts/`, `.agents/skills/mols-skill-creator/assets/` 등
...
1. `./SKILL.md`를 읽는다.
1. `./SKILL.md`가 실제로 참조하는 `.agents/skills/mols-skill-creator/references/`, `.agents/skills/mols-skill-creator/scripts/`, `.agents/skills/mols-skill-creator/assets/`와 다른 runtime resources를 필요한 만큼 읽는다.
...
- `.agents/skills/mols-skill-creator/references/`: runtime에서 필요할 때만 읽는 상세 지식
- `.agents/skills/mols-skill-creator/scripts/`: runtime에서 반복되거나 결정론적이어야 하는 작업
- `.agents/skills/mols-skill-creator/assets/`, `templates/`: runtime 결과에 필요한 자원
...
- 새 directory-based Skill 생성 시 `./scripts/init_skill.py` 또는 `.agents/skills/mols-skill-creator/assets/templates/`를 활용할 수 있다.
