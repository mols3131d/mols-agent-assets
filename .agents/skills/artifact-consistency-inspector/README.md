...
`.agents/skills/artifact-consistency-inspector/references/`는 runtime에서 조건부로 읽는 resource이고, `.agents/skills/artifact-consistency-inspector/tests/`는 source package의
