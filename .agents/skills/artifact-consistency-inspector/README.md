...
`.agents/skills/artifact-consistency-inspector/references/`는 runtime에서 조건부로 읽는 resource입니다. Repository-owned deterministic tests와 scenarios는 deployable package 밖 `tests/skills/artifact-consistency-inspector/`에서 관리합니다.
