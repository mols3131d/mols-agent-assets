...
- `./README.md` and `.agents/skills/artifact-consistency-inspector/tests/` are maintainer/development-facing package material. Repository maintainer docs live outside the runtime package and are never evidence from the inspected repository.
