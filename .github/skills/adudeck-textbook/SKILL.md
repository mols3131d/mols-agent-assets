...
description: Define and enforce the adudeck textbook contract for structuring, reviewing, or deciding whether instructional material qualifies as a textbook. Use when a task concerns textbook architecture, chapter boundaries, instructional depth, worked examples, exercises, assessment, or textbook-quality review. Do not use for external research, curriculum design, source collection, repository or Notion placement, or writing the actual textbook prose; use adudeck-textbook-write for authoring.
---
