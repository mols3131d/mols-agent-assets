...
Repository 변경 절차는 [Development](docs/development/README.md)를 참고합니다. Agent-facing repository rules는 [`AGENTS.md`](AGENTS.md)가 소유합니다. 임시·전달용 non-canonical artifact는 [`inbox/`](inbox/README.md)를 사용합니다.
