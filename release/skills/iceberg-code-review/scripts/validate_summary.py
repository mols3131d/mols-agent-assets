#!/usr/bin/env python3
"""Validates a code review summary file."""
...
from _schema import SUMMARY_SCHEMA

LOGGER = logging.getLogger(__name__)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate code review summary file")
...
def main() -> int:
    ...
    expected_type = SUMMARY_SCHEMA["frontmatter"]["type"]["default"]
    errors.extend(
