...
- If `rumdl` CLI tool missing:
  ...
  1. If format fails, delegate to manual format: collapse consecutive empty lines to max of one, strip trailing whitespace, ensure single trailing newline at EOF.
