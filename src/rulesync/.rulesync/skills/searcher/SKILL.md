...
1. If a search path dead-ends, recycles the same provenance, or stops reducing uncertainty, backtrack to the last supported state and pursue a materially different lead, query dimension, tool, or source class instead of merely rephrasing the query.
