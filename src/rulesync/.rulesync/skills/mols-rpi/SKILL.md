...
name: mols-rpi
description: >-
  Run adaptive RPI orchestration: Research → Plan → Implementation/Work → Review prerequisites with Review-driven iteration.
