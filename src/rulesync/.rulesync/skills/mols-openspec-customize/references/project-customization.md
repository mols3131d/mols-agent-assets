...
Use this reference only when customizing OpenSpec for a concrete project or
repository. The target repository and observed project use are evidence and
authority for project-specific decisions.
...
Use [Customization patterns](customization-patterns.md) to choose the smallest
supported surface and [Official customization](official-customization.md) to confirm
exact mechanics. Leave information outside OpenSpec when OpenSpec does not need it.
...
maintenance-surface guidance in [Customization patterns](customization-patterns.md)
without redefining it here. Do not create companion files as ceremony.
...
dogfooding and tuning method in
...
for claims about resolved behavior. This reference only adds project-specific
evidence and uncertainty: which repository state was inspected, which representative
cases informed the decision, and which project facts could not be verified.
