...
A candidate must identify a concrete installable projection. If multiple sibling variants remain unresolved, return to `mols-skill-find` rather than choosing by filename, package size, or directory name.
