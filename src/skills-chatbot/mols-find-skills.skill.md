...
Return discovery results in a form that `mols-install-skills` can consume. For each capability, preserve at least:
...
- Do not include installation instructions unless the caller asks; hand mutation ownership to `mols-install-skills`.
