...
Return discovery results in a form that `install-skills` can consume. For each capability, preserve at least:
...
- Do not include installation instructions unless the caller asks; hand mutation ownership to `install-skills`.
