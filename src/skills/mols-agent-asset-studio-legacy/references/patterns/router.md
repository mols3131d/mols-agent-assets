...
1. **Define Boundaries**: Write a `description` containing positive scope and explicit exclusions.
1. **Establish Route Index**: Generate `name,description` entries from workflow frontmatter.
