...
1. Verify the script functions correctly and covers all intended mechanical steps.
1. Update the target markdown workflow:
   - Insert the explicit command invocation for the script.
   - Remove the obsolete natural language instructions.
1. Run [frontmatter-validate.md](../frontmatter-validate.md) and relevant
