...
1. Define skill job, triggers, outputs, and exclusions.
1. Create `SKILL.md` with the minimum structure in [architecture.md](../references/agent-skill/architecture.md).
1. Write frontmatter following [frontmatter.md](../references/agent-skill/frontmatter.md).
1. Put execution rules in `SKILL.md`; move passive knowledge to `references/` or `assets/`.
1. Run [frontmatter-validate.md](frontmatter-validate.md).
1. For routing skills, run [router-asset-maintain.md](router-asset-maintain.md).
