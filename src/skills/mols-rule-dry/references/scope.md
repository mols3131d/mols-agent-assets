...
Verify declarative scopes and metadata completely when the affected set can be enumerated. For relevance-based or agent-selected attachment, static inspection can verify only the declared selection contract; runtime selection remains unverified unless an evaluation system is available.
