...
def create_detail(summary_file: Path, domain: str, detail: str) -> Path:
    ...
    destination = summary_file.parent / f"{domain}-{detail}.md"
...
def main() -> int:
    ...
    try:
        destination = create_detail(args.summary_file, args.domain, args.detail)
